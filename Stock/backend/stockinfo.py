...
def get_symbols():
    ...
    file_path = os.path.join(module_dir, "all_symbols_vn.pkl")
...
#         df = yf.download(symbol, period=period, interval=interval)
        ...
        df = get_data_from_vnstock(symbol, period=period, interval=interval)
        return df
...
#         hist = tick.history(period="2d")
        hist = get_data_from_vnstock(symbol, period="2d")
